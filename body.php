...
<body>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-sm-pull-6" style="padding:20px;">
        ...
        <hr />
        <p>Welcome to my personal blog. My name is Saeem Osman and I am currently doing my undergrade at North South University in Computer Science and Engineering. My hobby is to learn and discover new things. I am a non-professional web-developer and programmer.</p>
        <div style="text-align:center"><button class="btn btn-light btn-lg" type="button" onclick="window.location.href='about.php'">Know more about me</button></div>
    </div>
